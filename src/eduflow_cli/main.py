...
from eduflow_cli.cli.common import envelope_from_args, load_json_from_stdin
...
from eduflow_cli.contracts.errors import EduflowError
from eduflow_cli.output.serializer import emit_json
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="eduflow")
...
def main() -> int:
    ...
    try:
        ...
        emit_json({
            ...
            "result": {},
            "meta": {"model": "eduflow-local", "latency_ms": 0, "session_id": None},
